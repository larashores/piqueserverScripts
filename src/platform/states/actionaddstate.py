from platform.commands.action.platformaction import PlatformAction, PLATFORM_ACTION_FUNCTIONS
from platform.commands.action.playeraction import PlayerAction, PLAYER_ACTION_FUNCTIONS
